...
public enum ErrorCode {
  ...
  SUBSCRIPTION_NOT_FOUND("AD1011", "error.applydays.SUBSCRIPTION_NOT_FOUND"),
  PAYMENT_FAILED("AD1013", "error.applydays.PAYMENT_FAILED"),
  INVALID_SUBSCRIPTION_STATUS("AD1014", "error.applydays.INVALID_SUBSCRIPTION_STATUS"),
  SUBSCRIPTION_EXPIRED("AD1015", "error.applydays.SUBSCRIPTION_EXPIRED"),
  BILLING_KEY_NOT_FOUND("AD1016", "error.applydays.BILLING_KEY_NOT_FOUND"),
