...
class AdminApplyDaysCommandServiceTest {
  ...
  @Test
  @DisplayName("인증 요청을 승인하면 즉시 승인 처리되고 이벤트를 발행한다")
  void approveRequest_success() {
    ...
    verify(eventPublisher).publishEvent(any(ApplicationApprovedEvent.class));
  ...
  @Test
  @DisplayName("인증 요청을 거절하면 Application 상태가 REJECTED가 되고 거절 이벤트를 발행한다")
