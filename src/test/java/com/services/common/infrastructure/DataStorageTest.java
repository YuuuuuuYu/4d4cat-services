...
class DataStorageTest {
  ...
  void setDataAndGetListData_shouldReturnStorageData() {
    ...
    // When
    Optional<List<PixabayVideoResult>> videoResult =
        DataStorage.getListData(videoKey, PixabayVideoResult.class);
    Optional<List<PixabayMusicResult>> musicResult =
        DataStorage.getListData(musicKey, PixabayMusicResult.class);
  ...
  void getRandomElement_shouldReturnRandomElement() {
    ...
    // When
    Optional<PixabayVideoResult> videoResult =
        DataStorage.getRandomElement(videoKey, PixabayVideoResult.class);
    Optional<PixabayMusicResult> musicResult =
        DataStorage.getRandomElement(musicKey, PixabayMusicResult.class);
  ...
  void getRandomElement_shouldReturnEmptyElement_whenNotStoredData() {
    ...
    // Then
    assertAll(() -> assertThat(videoResult).isEmpty(), () -> assertThat(musicResult).isEmpty());
  }
  ...
  void getRandomElement_shouldReturnEmptyElement_whenGetNotExistKey() {
    ...
    // When
    Optional<PixabayVideoResult> videoResult =
        DataStorage.getRandomElement(nonExistentKey, PixabayVideoResult.class);
    Optional<PixabayMusicResult> musicResult =
        DataStorage.getRandomElement(nonExistentKey, PixabayMusicResult.class);
