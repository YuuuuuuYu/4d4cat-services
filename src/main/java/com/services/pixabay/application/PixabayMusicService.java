...
public class PixabayMusicService
    extends DataInitializationService<
        PixabayMusicResult, PixabayMusicRequest, CustomPixabayMusicResponse<PixabayMusicResult>> {
  ...
  @Override
  public PixabayMusicResult getRandomElement() {
    return DataStorage.getRandomElement(
        getStorageKey(), PixabayMusicResult.class, ErrorCode.PIXABAY_MUSIC_NOT_FOUND);
  }
}
